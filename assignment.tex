...
\newminted{java}{bgcolor=codebg,linenos=true,numbersep=6pt,mathescape=true,texcl=true,gobble=2}
\newmintedfile{java}{bgcolor=codebg,linenos=true,numbersep=6pt,stepnumber=5,mathescape=true,texcl=true}
